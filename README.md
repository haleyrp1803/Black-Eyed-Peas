...
Although they were not a high status item by the time Carracci's peasant sat down for his meal, authors since ancient times have described cowpeas in texts on plants and the natural world. In European botany there has long existed a confusion regarding the plant’s common and Latin names, some of this stemming from ever-changing ideas of the pea’s origins and classification. More recently, taxonomists have been re-classifying the genus Vigna and today all cultivated cowpeas are grouped under <i>Vigna unguiculata</i> subsp.unguiculata. However, it was well known by many names throughout ancient Eurasia, and was understood as a nutritious source of food for humans and livestock alike.
